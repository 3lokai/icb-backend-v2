...
from .extractors import (
    ...
    extract_phone_number, extract_social_links,
    extract_description, extract_tags
)
...
class RoasterScraper:
    ...
    async def _extract_basic_info(self, roaster_data: Dict[str, Any], soup: BeautifulSoup, html_content: str, url: str, platform: str) -> None:
    ...
    def _cleanup_data(self, roaster_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        roaster_data["is_verified"] = roaster_data.pop("is_verified", False) # Keep existing if present, default to False
