            ...
            try:
                ...
                if not name or not url:
                    errors.append({
                        'name': name,
                        'url': url,
                        'error': 'Missing name or URL in input'
                    })
                    continue
...
async def process_roaster_batch(scraper: RoasterScraper, roaster_list: List[Dict[str, str]]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
