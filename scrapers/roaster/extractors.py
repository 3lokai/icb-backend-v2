    ...
    for selector in content_selectors:
        ...
        if content:
            ...
            if substantial_paragraphs:
                ...
                coffee_paragraphs = [p for p in substantial_paragraphs 
...
def extract_hero_image(soup: BeautifulSoup, url: str) -> Optional[str]:
    ...
    selectors = [
        '.hero img', '.banner img', '.hero-image', 
        '.banner-image', '.main-banner img', 
        '.slideshow img:first-child', '.hero-banner img',
        '.slides img:first-child', '.splash img', 
        '.carousel-item:first-child img', '.carousel img:first-child',
        '.home-banner img', '.featured-image img',
        '[data-section-type="hero"] img', '[data-section-type="slideshow"] img'
    ]
...
def check_business_features(roaster_data: Dict[str, Any], soup: BeautifulSoup, html_content: str) -> Dict[str, Any]:
    ...
    store_indicators = [
        'visit us', 'our store', 'physical location', 'cafe', 'visit our', 
        'directions', 'opening hours', 'open from', 'coffee shop', 'location'
    ]
