...
try:
    from crawl4ai import AsyncWebCrawler, CrawlerRunConfig, LLMConfig as Crawl4AILLMConfig
...
async def enrich_roaster_data_with_crawl4ai(roaster_data: Dict[str, Any], url: str) -> Dict[str, Any]:
    ...
    fields_to_enrich = [
        'description', 'founded_year', 'has_subscription', 'has_physical_store', 'social_links'
    ]
    ...
    llm_strategy = LLMExtractionStrategy(
        llm_config=Crawl4AILLMConfig(
            ...
            api_token=config.llm.deepseek_api_key
        ),
