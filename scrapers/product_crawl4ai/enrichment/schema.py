...
class CoffeeProductSchema(BaseModel):
    ...
    name: str = Field(description="The full name of the coffee product as shown on the product page")
    ...
    bean_type: Optional[str] = Field(
        None, description="The type of coffee bean (e.g., arabica, robusta, liberica, blend, mixed-arabica)"
    )
    ...
    region_name: Optional[str] = Field(
        None, description="The geographical origin of the coffee - country, region, estate, or farm name"
    )

    is_single_origin: Optional[bool] = Field(
        None, description="Whether the coffee is single origin (true) or a blend of multiple origins (false)"
    )
    ...
    price: Optional[Union[float, str]] = Field(
        None, description="The price of the coffee (either a number or with currency symbol like $19.99, ₹450)"
    )

    size_grams: Optional[Union[int, str]] = Field(
        None, description="The package size in grams (e.g., 250g, 500g, 1kg). Convert kg to grams if needed."
    )

    image_url: Optional[str] = Field(None, description="Full URL of the main product image, including the domain name")
    ...
    harvest_period: Optional[str] = Field(None, description="When the coffee was harvested or the harvest season")
    ...
    body: Optional[str] = Field(
        None, description="The body or mouthfeel of the coffee (e.g., light, medium, full, syrupy, tea-like)."
    )

    sweetness: Optional[str] = Field(
        None, description="The perceived sweetness of the coffee (e.g., honey-like, caramel, brown sugar, low)."
    )
    ...
    with_milk_suitable: Optional[bool] = Field(
        None, description="Whether the coffee is particularly recommended for or suitable with milk (true or false)."
    )
