...
async def fetch_with_retry(url, client=None, max_retries=3, headers=None, timeout=None, rate_limit=False, rate_limiter=None):
...
def is_coffee_product(name, description=None, product_type=None, tags=None, roaster_name="Unknown", url=""):
    ...
    non_coffee_terms = [
        'grinder', 'machine', 'mug', 'cup', 'filter', 'chocolate', 'tool',
        'course', 'workshop', 'kettle', 'dripper', 'aeropress', 'v60', 
        'chemex', 'carafe', 'equipment', 'accessory', 'maker', 'bootcamp',
        'skills', 'program', 'sensory', 'barista', '101:', 'masterclass',
        'paper', 'bag', 'spoon', 'french press', 'scale', 'stagg', 'reusable',
        'class', 'throwdown', 'event', 'course', 'gift card', 'subscription',
        'gift', 'course', 'workshop', 'academy', 'training', 'espresso machine', 'day in the life',
        'coffee maker', 'coffee grinder', 'coffee cup', 'coffee mug', 'coffee filter',
    ]
    ...
    coffee_keywords = [
        'micro climate', 'selection', 'signature', 'grand reserve', 
        'pocket brew', 'arabica', 'robusta', 'single origin', 'blend',
        'specialty', 'direct trade', 'direct sourced', 'freshly roasted', 'civet',
        'moroccan', 'liberica', 'decaf', 'vienna roast', 'espresso roast', 'attikan',
        'dark roast', 'medium roast', 'light roast', 'coffee beans', 'coffee blend',
        'filter coffee', 'balmaadi wild', 'malabar', 'peaberry', 'julien peak', 
        'salawara reserve', 'old kent vienna', 'thogarihunkal', 'salawara', 'ratnagiri',
        'mandalkhan', 'l&#8217;lmore', 'turkish', 'unakki', 'terrazas del pisque sidra'
    ]
    ...
    bean_indicators = [
        ...
        'single origin', 'arabica beans', 'robusta beans',
        'fruity notes', 'chocolate notes', 'caramel notes'
    ]
...
def standardize_bean_type(bean_text):
    ...
    arabica_varietals = ['bourbon', 'typica', 'gesha', 'geisha', 'sl-', 'sl28', 'sl34', 
                         'caturra', 'catuai', 'catimor', 'pacamara', 'maragogipe', 'pacas']
