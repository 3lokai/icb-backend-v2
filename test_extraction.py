...
async def test_extraction():
    ...
    try:
        async with AsyncWebCrawler(config=BrowserConfig(headless=True)) as crawler:
            async for result in crawler.arun(url=url, config=crawler_config):
                ...
                if result.extracted_content:
                    ...
                    async for css_result in crawler.arun(url=url, config=css_crawler_config):
                        ...
                        break  # Exit after first CSS result
                break  # Exit after first LLM result
